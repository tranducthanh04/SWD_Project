  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError(getErrorMessage(err, 'Unable to load enterprise dashboard'));
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-3">
        <div className="card-panel p-6">
          <div className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-700">Total jobs</div>
        ...
        <div className="card-panel p-6">
          <div className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-700">Pending review</div>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <div className="card-panel p-6">
          <div className="flex items-center justify-between">
            ...
            <Link to="/enterprise/jobs" className="text-sm font-semibold text-brand-700">Manage</Link>
          </div>
        ...
        <div className="card-panel p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-slate-900">Recent applicants</h2>
            <Link to="/enterprise/jobs" className="text-sm font-semibold text-brand-700">Review</Link>
          </div>
          <div className="mt-4 space-y-3">
